            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('kendaraan.store') }}" method="POST"
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea name="deskripsi" value="{{ old('deskripsi') }}" required class="form-control" id="deskripsi"
                                        placeholder="Nama Kendaraan"></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="tahun" value="{{ old('tahun') }}" required
                                        class="form-control" id="tahun" placeholder="Tahun">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="file" name="img" value="{{ old('img') }}" required
                                        class="form-control" id="img" placeholder="Gambar Kendaraan">
                                    <label for="img">Nama Kendaraan</label>
                                </div>
                            </div>
